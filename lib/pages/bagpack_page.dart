...
class BagPackPage extends StatelessWidget {
  ...
  final controller=Get.find<MedicineListController>();
              ...
              child: ListView.separated(
                padding: EdgeInsets.symmetric(horizontal: 30,vertical: 20),
                  ...
                  final item=controller.medicines[index];
                    return InkWell(
                      onTap: (){
                        Get.toNamed(AppRoutes.detail,arguments: {"medicine":item});
                      },
                      child: Container(
                              ...
                              children: [
                                Container(
                                  ...
                                  child: ClipRRect(
                                    borderRadius: BorderRadius.circular(10),
                                      child: MDPHero(
                                          tag: "medicine_image_${item.id}",child: Image.network(item.image??"",fit: BoxFit.cover,))
                                  ),
                                ),
                                Flexible(child: Padding(
                                  ...
                                  child: Column(
                                    ...
                                    children: [
                                      MDPHero(
                                          tag: "medicine_title_${item.id}",child: Text(item.title??"",style: Theme.of(context).textTheme.subtitle1,)),
                                      SizedBox(height: 5,),
                                      Text("Qty: 3")
                                    ],
                                  ),
